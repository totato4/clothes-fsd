export const arrMenu = [
  ...
  {name:"Обувь  ", subcategory: ["Кроссовки", "Туфли", "Ботинки", "Тапочки", "Сандали"]},
  {name: " Аксессуары ", subcategory: ["Брелки", "Цепочки", "Ожерелья", "Галстуки"]},
  {name: "Спорт", subcategory: [
    "Кросовки для бега",
    "Спортивные костюмы",
  ...
  {name: " Распродажа ", subcategory: ["Товары со скидкой", "Уцененные товары"]},
]
  },
  {
    name: "МУЖЧИНАМ",
